...
describe('Service Tests', () => {
  describe('UnitOfMeasure Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should create a UnitOfMeasure', async () => {
      ...
      it('should update a UnitOfMeasure', async () => {
        const returnedFromService = Object.assign(
          {
            name: 'BBBBBB'
          },
      ...
      it('should return a list of UnitOfMeasure', async () => {
        const returnedFromService = Object.assign(
          {
            name: 'BBBBBB'
          },
      ...
      it('should delete a UnitOfMeasure', async () => {
