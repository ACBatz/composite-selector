...
describe('Service Tests', () => {
  describe('Load Service', () => {
    ...
    beforeEach(() => {
      ...
      expectedResult = {};
      injector = getTestBed();
      service = injector.get(LoadService);
      httpMock = injector.get(HttpTestingController);

      elemDefault = new Load(0, 'AAAAAAA', false, false);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should return a list of Load', async () => {
        const returnedFromService = Object.assign(
          {
            name: 'BBBBBB',
            isTensileOrCompressive: true,
